...
class Ui_groups(object):
    def setupUi(self, groups):
        ...
        self.gridLayout.addWidget(self.grouplist, 1, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.memberlist, 3, 0, 1, 2)
        self.adduserle = QtWidgets.QLineEdit(groups)
        self.adduserle.setObjectName("adduserle")
        self.gridLayout.addWidget(self.adduserle, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.creategrouple, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.refreshbtn, 4, 0, 1, 2)
        self.deletegroupbtn = QtWidgets.QPushButton(groups)
        self.deletegroupbtn.setObjectName("deletegroupbtn")
        self.gridLayout.addWidget(self.deletegroupbtn, 7, 0, 1, 2)
